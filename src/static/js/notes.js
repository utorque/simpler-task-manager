...
window.NotesView = (function () {
    ...
    // --- Promote-to-task ---
    // A self-contained confirm modal pre-filled with the draft(s) returned by
    // the promote route; confirming creates the task(s) via the existing
    // POST /api/tasks. The note's content is never touched.
