...
- **Cleanify**: LLM tidy of a note, returned without persisting; applied in-editor, persists via normal autosave; single-step Undo; degrades to original on failure.
